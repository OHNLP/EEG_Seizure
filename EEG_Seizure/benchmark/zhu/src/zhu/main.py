...
def main(edf_file, outFile):
    ...
    y_predict = get_predict_mask(
        preds, recording_duration, fs, window_size_sec, overlap_sec)
...
if __name__ == "__main__":
    ...
    for edf_file in natsort.natsorted(edf_file_list):
        ...
        outFile = edf_file.replace(
            "BIDS_Siena", "BIDS_Siena_zhu_pred").replace(".edf", ".tsv")
